...
from valuecell.core.storage.factory import create_conversation_store, create_item_store
...
STRATEGY_AGENT_NAMES = {
    ...
    "GridStrategyAgent",
    "LongTermSpotRsiStrategyAgent",
    "ShortTermSpotRsiStrategyAgent",
    "ColdAltSpotStrategyAgent",
}
...
class ConversationService:
    ...
    def __init__(self):
        ...
        self.item_store = create_item_store()

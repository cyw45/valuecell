...
def create_strategy_agent_router() -> APIRouter:
    ...
    async def create_strategy_agent(
        ...
        try:
            ...
            if strategy_type_enum == StrategyType.PROMPT:
            ...
            elif strategy_type_enum == StrategyType.LONG_TERM_SPOT_RSI:
                agent_name = "LongTermSpotRsiStrategyAgent"
            elif strategy_type_enum == StrategyType.SHORT_TERM_SPOT_RSI:
                agent_name = "ShortTermSpotRsiStrategyAgent"
            elif strategy_type_enum == StrategyType.COLD_ALT_SPOT:
                ...
                raise HTTPException(
                    ...
                    detail=(
                        ...
                        "Use 'PromptBasedStrategy', 'GridStrategy', "
                        "'LongTermSpotRsiStrategy', 'ShortTermSpotRsiStrategy', "
                        "or 'ColdAltSpotStrategy'"
                    ),
                )

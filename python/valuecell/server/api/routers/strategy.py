        ...
        try:
            ...
            def normalize_strategy_type(
                ...
                if val is None:
                    ...
                    if "longtermspotrsi" in agent_name:
                        return StrategyType.LONG_TERM_SPOT_RSI
                    if "shorttermspotrsi" in agent_name:
                        return StrategyType.SHORT_TERM_SPOT_RSI
                    if "coldaltspot" in agent_name:
                        return StrategyType.COLD_ALT_SPOT
                    return None
                ...
                if raw_compact in (
                    ...
                    if raw_compact.startswith("prompt"):
                        return StrategyType.PROMPT
                    if raw_compact.startswith("grid"):
                        return StrategyType.GRID
                    if raw_compact.startswith("long"):
                        return StrategyType.LONG_TERM_SPOT_RSI
                    if raw_compact.startswith("short"):
                        return StrategyType.SHORT_TERM_SPOT_RSI
                    return StrategyType.COLD_ALT_SPOT
                if raw in (
                    "prompt",
                    ...
                    if raw == "grid":
                        return StrategyType.GRID
                    if raw == "longtermspotrsi":
                        return StrategyType.LONG_TERM_SPOT_RSI
                    if raw == "shorttermspotrsi":
                        return StrategyType.SHORT_TERM_SPOT_RSI
                    return StrategyType.COLD_ALT_SPOT

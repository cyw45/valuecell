...
class RuleStrategy(Base):
    ...
    strategy_kind = Column(String(32), nullable=False, default="configurable_rule", server_default="configurable_rule", index=True)
    strategy_version = Column(String(64), nullable=False, default="existing", server_default="existing")
    code_fingerprint = Column(String(128), nullable=False, default="legacy-configurable", server_default="legacy-configurable")
...
class RuleStrategyExecutionBatch(Base):
    ...
    strategy_kind = Column(String(32), nullable=False, default="configurable_rule", server_default="configurable_rule")
    strategy_version = Column(String(64), nullable=False, default="existing", server_default="existing")
    code_fingerprint = Column(String(128), nullable=False, default="legacy-configurable", server_default="legacy-configurable")
...
class RuleStrategyExecutionIntent(Base):
    ...
    reservation_id = Column(String(36), nullable=True, index=True)

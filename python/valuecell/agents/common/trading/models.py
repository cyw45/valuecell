...
class StrategyType(str, Enum):
    ...
    - LONG_TERM_SPOT_RSI: Long-term spot RSI ladder strategy
    - SHORT_TERM_SPOT_RSI: Short-term spot RSI ladder strategy
    """
    ...
    COLD_ALT_SPOT = "ColdAltSpotStrategy"
...
class LLMModelConfig(BaseModel):
    ...
    api_key: Optional[str] = Field(
        default=None,
        description="API key for the model provider (optional for rule-based strategies)",
    )
...
class TradingConfig(BaseModel):
    ...
    strategy_type: Optional[StrategyType] = Field(
        ...
        description=(
            "Strategy type: prompt, grid, long-term spot RSI, "
            "short-term spot RSI, or cold alt spot"
        ),
    )
